...
class FrmPersegi:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Sisi:',border=0, width=33, font=30, background="#DFA67B").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas:", border=0, width=33, font=30, background="#DFA67B").grid(row=4, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="keliling:", border=0, width=33, font=30, background="#DFA67B").grid(row=6, column=0, sticky=W, padx=5, pady=5)
