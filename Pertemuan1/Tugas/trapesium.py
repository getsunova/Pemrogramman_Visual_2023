...
class FrmTrapesium:
    ...
    def aturKomponen(self):
        mainFrame = Frame(self.parent, bd=10, background="#DFA67B")
        mainFrame.pack(fill=BOTH, expand=YES)

        # pasang Label

        Label(mainFrame, text='Alas:',border=0, width=35, font=30, background="#DFA67B").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi Sejajar:", border=0, width=35, font=30, background="#DFA67B").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Tinggi: ", border=0, width=35, font=30, background="#DFA67B").grid(row=5, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 1:", border=0, width=35, font=30, background="#DFA67B").grid(row=7, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 2:", border=0, width=35, font=30, background="#DFA67B").grid(row=9, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 3:", border=0, width=35, font=30, background="#DFA67B").grid(row=11, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 4:", border=0, width=35, font=30, background="#DFA67B").grid(row=13, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas:", border=0, width=35, font=30, background="#DFA67B").grid(row=16, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Keliling:", border=0, width=35, font=30, background="#DFA67B").grid(row=18, column=0, sticky=W, padx=5, pady=5)
        ...
        # Pasang Button
        self.btnHitung = Button(mainFrame, text='Hitung', command=self.onHitung,  border=0, width=15, font=20, background="#FFD966")
