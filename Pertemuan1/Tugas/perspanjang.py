...
class FrmPerspanjang:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text="Panjang:",border=0, width=10, font=30, background="#DFA67B").grid(row=0, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Lebar:", border=0, width=10, font=30, background="#DFA67B").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas:", border=0, width=10, font=30, background="#DFA67B").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Keliling:", border=0, width=10, font=30, background="#DFA67B").grid(row=4, column=0, sticky=W, padx=5, pady=5)
...
if __name__ == '__main__':  
    root = Tk() 
    aplikasi = FrmPerspanjang(root, "Program Luas dan Keliling Persegi Panjang")
    root.mainloop()