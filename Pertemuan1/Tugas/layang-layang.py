...
class FrmLayang:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Diagonal 1:',border=0, width=30, font=30, background="#DFA67B").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Diagonal 2:", border=0, width=30, font=30, background="#DFA67B").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        ...
        Label(mainFrame, text="Luas:", border=0, width=30, font=30, background="#DFA67B").grid(row=10, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Keliling:", border=0, width=30, font=30, background="#DFA67B").grid(row=12, column=0, sticky=W, padx=5, pady=5)
