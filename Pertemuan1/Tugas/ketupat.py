...
class FrmKetupat:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Panjang diagonal 1:',border=0, width=30, font=30, background="#DFA67B").grid(row=1, column=0, sticky=W, padx=20, pady=5)
        Label(mainFrame, text="Panjang diagonal 2:", border=0, width=30, font=30, background="#DFA67B").grid(row=3, column=0, sticky=W, padx=20, pady=5)
        Label(mainFrame, text="Sisi:", border=0, width=30, font=30, background="#DFA67B").grid(row=5, column=0, sticky=W, padx=20, pady=5)
        Label(mainFrame, text="Luas belah ketupat:", border=0, width=30, font=30, background="#DFA67B").grid(row=8, column=0, sticky=W, padx=20, pady=5)
        Label(mainFrame, text="keliling belah ketupat:", border=0, width=30, font=30, background="#DFA67B").grid(row=11, column=0, sticky=W, padx=20, pady=5)
