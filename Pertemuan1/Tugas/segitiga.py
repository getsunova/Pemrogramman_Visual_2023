...
class FrmSegitiga:
    ...
    def aturKomponen(self):
        ...
        # pasang Label
        Label(mainFrame, text='Alas:', border=0, width=30, font=30, background="#DFA67B").grid(row=1, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Tinggi:", border=0, width=30, font=30, background="#DFA67B").grid(row=3, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 1:", border=0, width=30, font=30, background="#DFA67B").grid(row=5, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 2:", border=0, width=30, font=30, background="#DFA67B").grid(row=7, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Sisi 3:", border=0, width=30, font=30, background="#DFA67B").grid(row=9, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="Luas:", border=0, width=30, font=30, background="#DFA67B").grid(row=12, column=0, sticky=W, padx=5, pady=5)
        Label(mainFrame, text="keliling:", border=0, width=30, font=30, background="#DFA67B").grid(row=14, column=0, sticky=W, padx=5, pady=5)
        ...
        # Pasang Button
        self.btnHitung = Button(mainFrame, text='Hitung', command=self.onHitung, border=0, width=20, font=30, background="#FFD966")
